...
public class RemoveOrder extends Thread implements Parse.ParseHttp{
    ...
    public RemoveOrder(Context context, String token, int orderid) {
    ...
    public void parseHttpResponse(HttpResponse httpResponse) {
        ...
        try {
            ...
            Log.i("删除订单", stringBuffer.toString());
    ...
    public void run() {
        ...
        HttpResponse httpResponse = request.sendHttpPostRequest(DELETE_ORDER, params);
