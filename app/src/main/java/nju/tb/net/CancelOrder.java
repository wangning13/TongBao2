...
public class CancelOrder extends Thread implements Parse.ParseHttp{
    ...
    public CancelOrder(Context context, String token, int orderid) {
    ...
    public void parseHttpResponse(HttpResponse httpResponse) {
        ...
        try {
            ...
            Log.i("取消订单", stringBuffer.toString());
    ...
    public void run() {
        ...
        HttpResponse httpResponse = request.sendHttpPostRequest(CANCEL_ORDER, params);
